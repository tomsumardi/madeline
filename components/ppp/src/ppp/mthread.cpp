...
#define PPP_MTHREAD_SLEEP_SEC      1
#define PPP_NO_ZC_BUFFER_LEN       9000
...
void mthread :: procPkts()
{
    ...
    u_int                _bufSize = PPP_NO_ZC_BUFFER_LEN;
        ...
        try{
            while(1)
                boost::this_thread::sleep(
                        boost::posix_time::seconds(PPP_MTHREAD_SLEEP_SEC));
        }
